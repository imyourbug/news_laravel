                        ...
                        <div class="row gutter--15">
                            <div class="col-md-6">
                                <div class="row gutter--15">
                                    ...
                                    @for ($i = 0; $i <= 1; $i++)
                                        @if (!empty($posts_new[$i][0]))
                                            <div class="col-xs-6 col-xss-12">
                                                <!-- Post Item Start -->
                                                <div class="post--item post--layout-1 post--title-large">
                                                    <div class="post--img">
                                                        <a href="{{ route('posts.show', $posts_new[$i][0]) }}"
                                                            class="thumb"><img style="height: 250px !important"
                            ...
                            <div class="col-md-6">
                                <!-- Post Item Start -->
                                <div style="" class="post--item post--layout-1 post--title-larger">
                                    <div class="post--img">
                                        <a href="{{ route('posts.show', $posts_new[3][0]) }}" class="thumb"><img style="height: 465px"
                                                src="{{ asset($posts_new[3][0]->image ? 'storage/' . $posts_new[3][0]->image->path : 'storage/placeholders/placeholder-image.png') }}"
                                                alt=""></a>
                                ...
                                <div class="col-md-6 ptop--30 pbottom--30">
                                    ...
                                    <div class="post--items post--items-2" data-ajax-content="outer">
                                        <ul class="nav row gutter--15" data-ajax-content="inner">
                                            @if (!empty($post_category_home0[0]))
                                                <li class="col-xs-12">
                                                    <!-- Post Item Start -->
                                                    <div class="post--item post--layout-1">
                                                        <div class="post--img">
                                                            <a href="{{ route('posts.show', $post_category_home0[0]) }}"
                                                                class="thumb"><img style="height: 200px !important"
                                            ...
                                            @for ($i = 1; $i <= 4; $i++)
                                                ...
                                                @endif
                                                @if (!empty($post_category_home0[$i]))
                                                    <li class="col-xs-6">
                                                        <!-- Post Item Start -->
                                                        <div class="post--item post--layout-2">
                                                            <div class="post--img">
                                                                <a href="{{ route('posts.show', $post_category_home0[$i]) }}"
                                                                    class="thumb"><img style="height: 200px"
                                        ...
                                        <ul class="nav row" data-ajax-content="inner">
                                            <li class="col-md-6">
                                                ...
                                                <ul class="list_news_show_home">
                                                    @for ($i = 4; $i <= 6; $i++)
                                                        @if (!empty($post_category_home2[$i]))
                                                            @if ($i != 6)
                                    ...
                                    <div class="post--items post--items-2" data-ajax-content="outer">
                                        <ul class="nav row gutter--15" data-ajax-content="inner">
                                                ...
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img">
                                                        <a href="{{ route('posts.show', $post_category_home3[0]) }}"
                                                            class="thumb"><img style="height: 200px;  object-fit: cover;
                                            ...
                                            @for ($i = 1; $i <= 4; $i++)
                                                ...
                                                @endif
                                                @if (!empty($post_category_home3[$i]))
                                                    <li class="col-xs-6">
                                                        <!-- Post Item Start -->
                                                        <div class="post--item post--layout-2">
                                                            <div class="post--img">
                                ...
                                <div class="col-md-6 ptop--30 pbottom--30">
                                    ...
                                    <div class="post--items post--items-3" data-ajax-content="outer">
                                        <ul class="nav" data-ajax-content="inner">
                                            ...
                                            @for ($i = 1; $i <= 5; $i++)
                                                @if (!empty($post_category_home4[$i]))
                                                    <li>
                                                        <!-- Post Item Start -->
                                                        <div class="post--item post--layout-3">
                                                            <div class="post--img">
                                                    ...
                                                    <div class="post--item post--layout-3">
                                                        <div class="post--img">
                                                            <a href="{{ route('posts.show', $outstanding_post) }}"
                                                                class="thumb"><img width = "120" style="height: 80px; width:100px; object-fit: cover;
                                                                object-position: center;"
                ...
                <div class="main--content pd--30-0">
                    ...
                    <div class="post--items post--items-4" data-ajax-content="outer">
                        <ul class="nav row" data-ajax-content="inner">
                            <li class="col-md-8">
                                <!-- Post Item Start -->
                                @if (!empty($post_category_home5[0]))
                                    <div class="post--item post--layout-1 post--type-video post--title-large">
                                        <div class="post--img">
                                            <a href="{{ route('posts.show', $post_category_home5[0]) }}"
                                                class="thumb"><img
                                            ...
                                            <div class="post--info">
                                                ...
                                                <div class="title">
                                                    <h2 class="h4"><a
                                                            ...
                                                            class="btn-link">{{ $post_category_home5[0]->title }}</a>
                                                    </h2>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <li class="col-md-4">
                                <ul class="nav">
                                    ...
                                    @for ($i = 1; $i <= 4; $i++)
                                        @if (!empty($post_category_home5[$i]))
                                            <li>
                                                <!-- Post Item Start -->
                        ...
                        <div class="sticky-content-inner">
                            <div class="row">
                                ...
                                <div class="col-md-6 ptop--30 pbottom--30">
                                    ...
                                    <div class="post--items post--items-3" data-ajax-content="outer">
                                        <ul class="nav" data-ajax-content="inner">
                                            @if (!empty($post_category_home6[0]))
                                                <li>
                                                    <!-- Post Item Start -->
                                                    <div class="post--item post--layout-1">
                                                        <div class="post--img">
                                            ...
                                            @endif
                                            @for ($i = 1; $i <= 4; $i++)
                                                @if (!empty($post_category_home6[$i]))
                                                    <li>
                                                        <!-- Post Item Start -->
                                                        <div class="post--item post--layout-3">
                                                            <div class="post--img">
                                ...
                                <div class="col-md-6 ptop--30 pbottom--30">
                                    ...
                                    <div class="post--items post--items-2" data-ajax-content="outer">
                                        <ul class="nav row gutter--15" data-ajax-content="inner">
                                            @if (!empty($post_category_home7[0]))
                                                <li class="col-xs-12">
                                                    <!-- Post Item Start -->
                                                    <div class="post--item post--layout-1">
                                                        <div class="post--img">
                                            ...
                                            @for ($i = 1; $i <= 4; $i++)
                                                ...
                                                @endif
                                                @if (!empty($post_category_home7[$i]))
                                                    <li class="col-xs-6">
                                                        <!-- Post Item Start -->
                                                        <div class="post--item post--layout-2">
                                                            <div class="post--img">
                                ...
                                <div class="col-md-12 ptop--30 pbottom--30">
                                    ...
                                    <div class="post--items post--items-2" data-ajax-content="outer">
                                        <ul class="nav row" data-ajax-content="inner">
                                            @if (!empty($post_category_home8[0]))
                                                <li class="col-md-6">
                                                    <!-- Post Item Start -->
                                                    <div class="post--item post--layout-2">
                                                        <div class="post--img">
                                                    ...
                                                    <ul class="list_news_show_home">
                                                        @for ($i = 3; $i <= 5; $i++)
                                                            @if (!empty($post_category_home8[$i]))
                                                                @if ($i != 5)
                                                                    <li class="boder_link_show_home">
                                                                        <h3 class="h3"><a
                                ...
                                <div class="col-md-12 ptop--30 pbottom--30">
                                    ...
                                    <div class="post--items post--items-1" data-ajax-content="outer">
                                        <ul class="nav row gutter--15" data-ajax-content="inner">
                                            @if (!empty($post_category_home9[0]))
                                                <li class="col-md-12">
                                                    <!-- Post Item Start -->
                                                    <div class="post--item post--layout-1 post--title-large">
                                                        <div class="post--img">
                                            ...
                                            @endif
                                            @for ($i = 1; $i <= 3; $i++)
                                                @if (!empty($post_category_home9[$i]))
