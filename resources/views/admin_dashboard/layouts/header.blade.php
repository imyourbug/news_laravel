        ...
        <nav class="navbar navbar-expand">
                    ...
                    <li class="nav-item dropdown dropdown-large">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <div class="header-message-list">
                                @for ($i = 0; $i < 10; $i++)
                                    @if (!empty($posts_comments[$i][0]))
                                        <a class="dropdown-item"
                                            href="{{ route('posts.show', $posts_comments[$i][0]) }}">
                                            <div class="d-flex align-items-center">
                                                <div class="user-online">
                                                    <img class="img_admn--user img-avatar " width="50"
                                                        height="50"
                                                ...
                                                <div style="margin-left: 10px;" class="flex-grow-1">
                                                    ...
                                                    <h6 class="msg-name">
                                                        {{ Str::limit($posts_comments[$i][0]->title, 32) }}</h6>
                                                </div>
                                            </div>
                                        </a>
                                    @endif
            ...
            <div class="user-box dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item" href="javascript:;"><i class="bx bx-cog"></i><span>Cài
                                đặt</span></a>
                    </li>
                    </li>
                    <li>
