                            ...
                            <div class="col-md-12 ptop--30 pbottom--30">
                                ...
                                <div class="post--items post--items-2" data-ajax-content="outer">
                                    <ul class="nav" data-ajax-content="inner">
                                        @for ($i = 0; $i < 4; $i++)
                                            @for ($j = 0; $j < 5; $j++)
                                                @if (!empty($hotPosts_category[$j][$i]))
                                                    <li>
                                                        <!-- Post Item Start -->
                                                        <div class="post--item">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="post--info">
                                                                        <ul class="nav meta">
                                                                            <li><span>{{ $hotPosts_category[$j][$i]->author->name }}</a>
                                                                            </li>
                                                                            <li><span>{{ $hotPosts_category[$j][$i]->created_at->locale('vi')->diffForHumans() }}</span>
                                                                            </li>
                                                                            <li><a href="#"><i
                                                                                        class="fa fm fa-eye"></i>{{ $hotPosts_category[$j][$i]->views }}</span>
                                                                            </li>
                                                                            <li><a
                                                                                    href="{{ route('posts.show', $hotPosts_category[$j][$i]) }}"><i
                                                                                        class="fa fm fa-comments"></i>{{ count($hotPosts_category[$j][$i]->comments) }}</a>
                                                                            </li>
                                                                        </ul>
                                                                        ...
                                                                        <div class="title">
                                                                            <h2 class="h3" style="color:black"><a
                                                                                    ...
                                                                                    class="btn-link">{{ $hotPosts_category[$j][$i]->title }}</a>
                                                                                </h3>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="post--action">
                                                                        <a class="btn btn-link"
                                                                            href="{{ route('posts.show', $hotPosts_category[$j][$i]) }}">Đọc
                                                                            thêm</a>
                                                                    </div>
                                                                </div>
                                                            </div>
